...
})({"5U0Xq":[function(require,module,exports) {
var HMR_HOST = null;var HMR_PORT = 1234;var HMR_SECURE = false;var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";module.bundle.HMR_BUNDLE_ID = "d1860b281e773ef683ae2c3ffc70f76c";/* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE */
...
(async function () {
  try {
    ...
    _dataViewJs.render(_dataModelJs.state.curData, _dataModelJs.updateData);
...
},{"core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","./dataView.js":"1Z7Nm","./dataModel.js":"PC393","./config.js":"1AI8K"}],"1PFvP":[function(require,module,exports) {
require('../es');
require('../web');
...
},{}],"1Z7Nm":[function(require,module,exports) {
...
const dataView = {
  ...
  editOutput: document.getElementById('data-container'),
...
function render(data, handler) {
  dataView.data = data;
  for (let key in data) {
    buildRow(dataView.data[key], key, handler);
  }
}
function addHandler() {}
function buildRow(month, key, handler) {
  ...
  dataView.tableOutput.append(row);
}
...
},{}],"PC393":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
_parcelHelpers.export(exports, "updateData", function () {
  return updateData;
});
const state = {
  data: [],
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1AI8K":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["5U0Xq","4QWci"], "4QWci", "parcelRequire39cf")
