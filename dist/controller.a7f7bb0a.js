...
})({"6f189ff804f94183846633f172511230":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "a7f7bb0a7222d6ab00b13707a1b564f6";
...
var dataController = _interopRequireWildcard(require("./dataController.js"));

var _dataView = _interopRequireDefault(require("./dataView.js"));
...
(async function () {
  try {
    ...
    curData = _dataModel.state.data;

    _dataView.default.render(_dataModel.state.data); //Set up quarter checkboxes with event listeners
...
async function loadData() {
  try {
    if (sessionStorage['data']) {
      ...
      _dataModel.state.data = JSON.parse(sessionStorage['data']);
    } else {
      const response = await fetch('data.json');
      _dataModel.state.data = await response.json();
      console.log(_dataModel.state.data);
...
function updateData(row) {
  var value = row.target.getAttribute("value");
  console.log(value);
  console.log(row.target.parentElement.parentElement.id);
}
},{"./dataModel.js":"0141af77cb3e37d0e163e463b1a2e034"}],"0141af77cb3e37d0e163e463b1a2e034":[function(require,module,exports) {
"use strict";
...
exports.state = state;
},{}],"3a1c00ebc1754cc3075a29cb1b9de0e2":[function(require,module,exports) {
"use strict";
...
var _tableOutput = new WeakMap();

var _editOutput = new WeakMap();

var _buildRow = new WeakSet();
...
class dataView {
  constructor() {
    ...
    _tableOutput.set(this, {
      writable: true,
      value: document.getElementById('data-container')
    });

    _editOutput.set(this, {
      writable: true,
      value: void 0
    });
  }
  ...
  render(data) {
    ...
    for (let key in data) {
      _classPrivateMethodGet(this, _buildRow, _buildRow2).call(this, _classPrivateFieldGet(this, _data)[key], key);
    }
  }

}

var _buildRow2 = function _buildRow2(month, key) {
  ...
  edit.onclick = dataController.updateData.bind(this);
...
var _default = new dataView();

exports.default = _default;
},{"./dataController.js":"eed106fa0c321ab8e25cdf1803bb852e"}],"d5ed5e3a2e200dcf66c948e6350ae29c":[function(require,module,exports) {
...
},{"../internals/export":"10044f24ecae4059b4af184e71d3fba2"}]},{},["6f189ff804f94183846633f172511230","3195aa7409a63b13499452e304916678"], null)

//# sourceMappingURL=controller.a7f7bb0a.js.map
