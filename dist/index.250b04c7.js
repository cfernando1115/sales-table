...
var _dataModelJs = require('./dataModel.js');
var _configJs = require('./config.js');
function controlData() {
  _dataViewJs.clearTable();
  _dataModelJs.clearCurrentData();
  _dataViewJs.isChecked(_dataModelJs.updateCurrentData);
  if (_dataModelJs.state.curData.length === 0) {
    _dataModelJs.updateCurrentData();
  }
  _dataViewJs.render(_dataModelJs.state.curData, controlForm);
}
;
function controlSort() {
  _dataViewJs.clearTable();
  _dataModelJs.sortBySales(_dataViewJs.clicks.salesClick);
  _dataModelJs.sortByName(_dataViewJs.clicks.nameClick);
  _dataViewJs.render(_dataModelJs.state.curData, controlForm);
}
function controlForm(row) {
  const value = row.target.getAttribute("value");
  const id = row.target.parentElement.parentElement.id;
  _dataViewJs.buildForm(value);
  _dataViewJs.addHandlerForm(controlEdit, id);
}
...
(async function () {
  try {
    await _dataModelJs.loadData(_configJs.DATA_PATH);
    _dataViewJs.render(_dataModelJs.state.curData, controlForm);
    // Set up quarter checkboxes with event listeners
    _dataViewJs.addHandlerQuarterBoxes(controlData);
    // Set up sales/name clicks
    _dataViewJs.addHandlerSalesClick(controlSort);
    _dataViewJs.addHandlerNameClick(controlSort);
  } catch (error) {
    alert(`There was an error: ${error.message}`);
  }
})();

},{"core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","./dataView.js":"7pkfe","./dataModel.js":"3Kq6t","./config.js":"6pr2F"}],"1PFvP":[function(require,module,exports) {
require('../es');
require('../web');
...
},{"../internals/export":"7f5VM","../internals/array-reduce":"5Navm","../internals/array-method-is-strict":"4NJHA","../internals/array-method-uses-to-length":"2faaS","../internals/engine-v8-version":"4TyYX","../internals/engine-is-node":"mb8j2"}],"5Navm":[function(require,module,exports) {
var aFunction = require('../internals/a-function');
var toObject = require('../internals/to-object');
var IndexedObject = require('../internals/indexed-object');
var toLength = require('../internals/to-length');
...
},{"../internals/export":"7f5VM","../internals/array-reduce":"5Navm","../internals/array-method-is-strict":"4NJHA","../internals/array-method-uses-to-length":"2faaS","../internals/engine-v8-version":"4TyYX","../internals/engine-is-node":"mb8j2"}],"YSU7n":[function(require,module,exports) {
'use strict';
var $ = require('../internals/export');
var isArray = require('../internals/is-array');
...
},{}],"7pkfe":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "clicks", function () {
  return clicks;
});
_parcelHelpers.export(exports, "render", function () {
  return render;
});
_parcelHelpers.export(exports, "addHandlerQuarterBoxes", function () {
  return addHandlerQuarterBoxes;
});
_parcelHelpers.export(exports, "addHandlerSalesClick", function () {
  return addHandlerSalesClick;
});
_parcelHelpers.export(exports, "addHandlerNameClick", function () {
  return addHandlerNameClick;
});
_parcelHelpers.export(exports, "addHandlerForm", function () {
  return addHandlerForm;
});
_parcelHelpers.export(exports, "clearTable", function () {
  return clearTable;
});
_parcelHelpers.export(exports, "isChecked", function () {
  return isChecked;
});
_parcelHelpers.export(exports, "buildForm", function () {
  return buildForm;
});
const elements = {
...
function render(data, handler) {
  for (let key in data) {
    buildRow(data[key], key, handler);
  }
}
function addHandlerQuarterBoxes(handler) {
...
function addHandlerSalesClick(handler) {
...
function addHandlerNameClick(handler) {
...
function addHandlerForm(handler, id) {
...
},{}],"3Kq6t":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "state", function () {
  return state;
});
_parcelHelpers.export(exports, "loadData", function () {
  return loadData;
});
_parcelHelpers.export(exports, "updateRow", function () {
  return updateRow;
});
_parcelHelpers.export(exports, "clearCurrentData", function () {
  return clearCurrentData;
});
_parcelHelpers.export(exports, "updateCurrentData", function () {
  return updateCurrentData;
});
_parcelHelpers.export(exports, "sortBySales", function () {
  return sortBySales;
});
_parcelHelpers.export(exports, "sortByName", function () {
  return sortByName;
});
const state = {
  data: [],
...
function updateRow(row, sales, salesperson) {
...
function updateCurrentData(quarter = 0) {
  switch (quarter) {
    case 1:
      {
        for (let i = 0; i < 3; i++) {
...
function sortBySales(salesClick) {
  switch (salesClick) {
    case 1:
      {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6pr2F":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "DATA_PATH", function () {
  return DATA_PATH;
});
const DATA_PATH = './data.json';

},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["5KYk0","3miIZ"], "3miIZ", "parcelRequire39cf")
